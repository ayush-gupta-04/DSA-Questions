// I am moving greedly here .. at a node i have many options but i am only taking the one smaller.
// If i found an ans from any path , then i am just returning true , because greedily the first path will be the smallest 
